...
namespace palleteColors {
    ...
    color pallete[] = {{0x75, 0x75, 0x75}, {0x27, 0x1B, 0x8F}, {0x00, 0x00, 0xAB}, {0x47, 0x00, 0x9F},
                       ...
                       {0xFF, 0xFF, 0xFF}, {0xAB, 0xE7, 0xFF}, {0xC7, 0xD7, 0xFF}, {0xC7, 0xD7, 0xFF},
                       {0xD7, 0xCB, 0xFF}, {0xFF, 0xC7, 0xFF}, {0xFF, 0xC7, 0xDB}, {0xFF, 0xBF, 0xB3},
                       {0xFF, 0xDB, 0xAB}, {0xFF, 0xE7, 0xA3}, {0xE3, 0xFF, 0xA3}, {0xAB, 0xF3, 0xBF},
                       {0xB3, 0xFF, 0xCF}, {0x9F, 0xFF, 0xF3}, {0x00, 0x00, 0x00}, {0x00, 0x00, 0x00},
                       {0x00, 0x00, 0x00}};
}